...
public class UAgentInfo {
	 ...
	 * inches and Honeycomb or later. This function will be updated rapidly as
	 * good tablets emerge in 2011.
	 */
	...
	public boolean detectBlackBerryHigh() {
		...
		if (this.detectBlackBerry()) {
			if (this.detectBlackBerryTouch() || this.userAgent.indexOf(deviceBBBold) != -1 || this.userAgent.indexOf(deviceBBTour) != -1 || this.userAgent.indexOf(deviceBBCurve) != -1) {
				return true;
			} else {
				return false;
			}
	...
	public boolean detectSmartphone() {
		return (this.detectIphoneOrIpod() || this.detectS60OssBrowser() || this.detectSymbianOS() || this.detectAndroid() || this.detectWindowsMobile() || this.detectWindowsPhone7() || this.detectBlackBerry() || this.detectPalmWebOS() || this.detectPalmOS() || this.detectGarminNuvifone());
	}
	...
	public boolean detectSymbianOS() {
		if (this.userAgent.indexOf(deviceSymbian) != -1 || this.userAgent.indexOf(deviceS60) != -1 || this.userAgent.indexOf(deviceS70) != -1 || this.userAgent.indexOf(deviceS80) != -1 || this.userAgent.indexOf(deviceS90) != -1) {
			return true;
		}
		return false;
	}
	...
	public boolean detectTierIphone() {
		if (this.detectIphoneOrIpod() || this.detectAndroid() || this.detectAndroidWebKit() || this.detectBlackBerryWebKit() || this.detectPalmWebOS() || this.detectGarminNuvifone() || this.detectMaemoTablet()) {
			return true;
		}
		return false;
	}
	...
	public boolean detectTierRichCss() {
		...
		if (this.detectMobileQuick() && (this.detectWebkit() || this.detectS60OssBrowser() || this.detectBlackBerryHigh() || this.detectWindowsPhone7() || this.detectWindowsMobile() || this.userAgent.indexOf(engineTelecaQ) != -1)) {
			return true;
		} else {
			return false;
		}
	...
	public boolean detectWindowsMobile() {
		...
		// devices.
		if (this.userAgent.indexOf(deviceWinMob) != -1 || this.userAgent.indexOf(deviceWinMob) != -1 || this.userAgent.indexOf(deviceIeMob) != -1 || this.userAgent.indexOf(enginePie) != -1 || (this.userAgent.indexOf(manuHtc) != -1 && this.userAgent.indexOf(deviceWindows) != -1)
